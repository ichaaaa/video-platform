...
class AdminController extends AbstractController
{
    ...
    public function categories(CategoryTreeAdminList $categories, Request $request)
    {
        ...
        return $this->render('admin/categories.html.twig', ['categories' => $categories->categoryList, 'form' => $form->createView(), 'isInvalid' => $isInvalid]);
    }
    ...
    public function editCategory(Category $category, Request $request)
    {
        ...
        return $this->render('admin/edit_category.html.twig', ['category'=>$category, 'form' => $form->createView(), 'isInvalid' => $isInvalid]);
    }
